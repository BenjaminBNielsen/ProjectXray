...
//            } else {
                ...
                int yearChanged = Integer.parseInt(cChangeYear.getSelectionModel().toString());
                
                 System.out.println(yearChanged);
                int monthChanged = Integer.parseInt(cChangeMonth.getSelectionModel().toString());
                int dayChanged = Integer.parseInt(cChangeDay.getSelectionModel().toString());
                int hourChanged = Integer.parseInt(cChangeStartHour.getSelectionModel().toString());
                int minuteChanged = Integer.parseInt(cChangeStartMinute.getSelectionModel().toString());
